    ...
    <div style={{ fontFamily: "'Tahoma', sans-serif", minHeight: "100vh"}}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          border: "1px solid rgba(200,220,232,0.08)", pointerEvents: "none",
        }} />
        <div style={{
        ...
        <p style={{
          fontSize: "0.7rem", letterSpacing: "0.2em", fontFamily: "'Tahoma', sans-serif",
          color: C.accentBlue, marginBottom: "20px", opacity: 0.7,
        }}>
          GET IN TOUCH
        </p>
        <h1 style={{
          ...
          Let's Create <em style={{ fontStyle: "italic", fontWeight: 700, color: C.accentBlue }}>Together</em>
        </h1>
        <p style={{
          fontSize: "1.02rem", color: "rgba(200,220,232,0.75)",
          ...
          {infoItems.map((item, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                fontWeight: 700, color: C.accentBlue, marginBottom: "10px", opacity: 0.8,
              }}>
                {item.label}
              </div>
              <div style={{ fontSize: "0.88rem", color: "rgba(240,246,250,0.85)", whiteSpace: "pre-line", lineHeight: 1.65 }}>
                {item.value}
              </div>
            </div>
          ))}
